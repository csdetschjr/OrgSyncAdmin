	...
	var AppSyncBox = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.state.view == "PORTAL") {
	            view = _react2.default.createElement(_portal2.default, { portal: this.state.portal, clearError: this.clearError, errorHandler: this.handleError,
	        ...
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(NavigationBox, { umbrella: this.state.umbrella, setUmbrella: this.setUmbrella, doSearch: this.doSearch,
	    ...
	    render: function render() {
	        ...
	        if (this.props.umbrella == undefined) {
	            ...
	            portalPick = _react2.default.createElement(
	                ...
	                _react2.default.createElement(PortalPickBox, { onSelect: this.props.doSearch, umbrellaId: this.props.umbrella, refs: 'portalPickBox' })
	            );
	        }
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'form-group' },
	                                    _react2.default.createElement(_umbrellaPick2.default, { umbrellaList: this.props.umbrellaList, change: this.props.setUmbrella })
	                                ),
	                                portalPick
	                            )
	                        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PortalBox = function (_React$Component) {
	    ...
	    (0, _createClass3.default)(PortalBox, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(PortalViewBox, { portal: this.props.portal, clearError: this.props.clearError, errorHandler: this.props.handleError,
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(_control2.default, { add: this.addSubmit, remove: this.removeSubmit, completeState: this.completeState, state: this.state.toggleState,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ControlBox = function (_React$Component) {
	    ...
	    (0, _createClass3.default)(ControlBox, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(ControlActionBox, { add: this.props.add, remove: this.props.remove, completeState: this.props.completeState, state: this.props.state,
	    ...
	    render: function render() {
	        if (this.props.state == "LIST") {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(ActionBox, { complete: this.props.completeState, inputData: this.props.inputData,
	...
	var PermissionsViewBox = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(PermissionToggleBox, { state: this.state.toggleState, toggle: this.changeToggleState }),
	            action
	        );
	    }
	});
	    ...
	    render: function render() {
	        ...
	        if (this.state.userPermissions != null && this.state.userPermissions.length != 0) {
	            umbrellaSelect = _react2.default.createElement(
	                ...
	                _react2.default.createElement(_umbrellaPick2.default, { umbrellaList: this.state.userPermissions, change: this.setUmbrella })
	            );
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UmbrellaPickBox = function (_React$Component) {
	    ...
	    (0, _createClass3.default)(UmbrellaPickBox, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(UmbrellaBox, { umbrellaList: this.props.umbrellaList, change: this.props.change });
	        }
	    }]);
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'col-md-9' },
	                _react2.default.createElement(FilterBox, { filterToggle: this.filterToggle, changeUsername: this.changeUsername,
	...
	var OrgsyncSettingsViewBox = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(LiveToggleBox, { state: this.state.toggleState, toggle: this.changeToggleState }),
	            _react2.default.createElement(SettingsInputBox, { liveUrl: this.state.liveUrl, testUrl: this.state.testUrl,
