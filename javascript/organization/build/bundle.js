...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppSyncBox = React.createClass({
	    ...
	    setUmbrella: function setUmbrella(newUmbrella) {
	    ...
	    doSearch: function doSearch(datum) {
	    ...
	    getMembers: function getMembers(datum) {
	        $.ajax({
	    ...
	    updatePortals: function updatePortals() {
	        $.ajax({
	    ...
	    getGroups: function getGroups(datum) {
	...
	var UmbrellaPickBox = React.createClass({
	    ...
	    change: function change() {
	        ...
	        var uChoice = _reactDom2.default.findDOMNode(this.refs.umbrellaChoice);
	        var value = uChoice.value;
	        this.props.change(value);
	    },
	    // Retrieves the umbrellas from the server via an ajax call.
	    getUmbrellas: function getUmbrellas() {
	        $.ajax({
	...
	var PortalBox = React.createClass({
	    ...
	    changeToggleState: function changeToggleState(newState) {
	    ...
	    addSubmit: function addSubmit(addText) {
	    ...
	    // and then passes the array to the createData function as well as a flag
	    // that tells it that the users are to be added to the group/portal.
	    removeSubmit: function removeSubmit(removeText) {
	    ...
	    createData: function createData(parsedTextData, caller) {
	        var newData = Array();
	        for (i = 0; i < parsedTextData.length; i++) {
	            if (parsedTextData[i] != "") {
	    ...
	    singleRemove: function singleRemove(email) {
	        var name;
	        var i = 0;
	    ...
	    processAdd: function processAdd(addData) {
	        var i = 0;
	    ...
	    processRemove: function processRemove(removeData) {
	        var i = 0;
	    ...
	    getGroupMembers: function getGroupMembers(newGroup) {
	    ...
	    addPortalStudent: function addPortalStudent(addInput, index) {
	    ...
	    addGroupStudent: function addGroupStudent(addInput, index) {
	    ...
	    removePortalStudent: function removePortalStudent(removeInput, index) {
	    ...
	    removeGroupStudent: function removeGroupStudent(removeInput, index) {
	...
	var OptionBox = React.createClass({
	    ...
	    // this student node.
	    listRemove: function listRemove() {
